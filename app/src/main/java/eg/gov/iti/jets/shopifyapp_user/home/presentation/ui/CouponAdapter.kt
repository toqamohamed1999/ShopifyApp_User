...
class CouponAdapter( var discounts: ArrayList<DiscountCode> , var myListener: CouponClickListener,var viewPager2: ViewPager2):RecyclerView.Adapter<CouponAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when(img){
            1->{
                holder.binding.discountImageView.setImageDrawable(ResourcesCompat.getDrawable(holder.binding.root.resources,R.drawable.x1,null))
            }
            2->{
                holder.binding.discountImageView.setImageDrawable(ResourcesCompat.getDrawable(holder.binding.root.resources,R.drawable.x2,null))
            }
            3->{
                holder.binding.discountImageView.setImageDrawable(ResourcesCompat.getDrawable(holder.binding.root.resources,R.drawable.x3,null))
            }
            4->{
                holder.binding.discountImageView.setImageDrawable(ResourcesCompat.getDrawable(holder.binding.root.resources,R.drawable.x4,null))

            }
            else->{
                holder.binding.discountImageView.setImageDrawable(ResourcesCompat.getDrawable(holder.binding.root.resources,R.drawable.x5,null))
            }
        }
